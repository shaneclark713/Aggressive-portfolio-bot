...
def build_telegram_app(token: str, app_services, config_service, admin_chat_id: int):
    ...
    handlers = dedupe_handlers([
        ...
        build_admin_handlers(app_services, config_service, admin_chat_id),
    ...
    logger.info("Registered Telegram handlers: handler_count=%s command_count=%s commands=%s",summary['handler_count'],summary['command_count'],summary['commands'])
