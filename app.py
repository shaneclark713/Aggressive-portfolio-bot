...
async def main() -> None:
    ...
    try:
        ...
        risk_service = RiskService(settings_repo, trade_repo, config_service) if RiskService is not None else None
        try:
        ...
        ticker_research_service = TickerResearchService(
            ...
            news_client=news,
            options_chain_ingest=options_chain_ingest_service,
